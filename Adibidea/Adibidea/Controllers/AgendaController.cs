...
namespace Adibidea.Controllers
{
    public class AgendaController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            Kontaktua kontaktua1 = new Kontaktua("13456765", "iker", "Gallastegui");
            kontaktua1.Emaila = "igallasteguie@uni.eus";
        ...
        {
            Kontaktua kontaktua = new Kontaktua("13456765", "iker", "Gallastegui");
            kontaktua.Emaila = "igallastegui@uni.eus";
